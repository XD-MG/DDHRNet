...
def evaluate(cfg, ckpt_dir=None, use_gpu=False, use_mpio=False, **kwargs):
    ...
    print("[EVAL]#image={} acc={:.2f} IoU={:.2f}".format(
        num_images, avg_acc*100, avg_iou*100))
    print("[EVAL]Category IoU:", category_iou*100)
    print("[EVAL]Category Acc:", category_acc*100)
    print("[EVAL]Kappa:{:.2f}".format(conf_mat.kappa()*100))
